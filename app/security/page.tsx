          ...
          <Dialog.Trigger asChild>
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                {/* summary */}
                <p className={`text-zinc-500 text-xs leading-relaxed mb-4 flex-1 ${lang === 'ar' ? 'text-right' : ''}`}>
                  {it.summary}
                </p>
            ...
            <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-full max-w-lg mx-4 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95">
              <div className="relative bg-zinc-950 border border-zinc-800 rounded-md overflow-hidden shadow-[0_32px_80px_rgba(0,0,0,0.8)]">
                ...
                <div className="p-5">
                  ...
                  <p className={`text-zinc-400 text-sm leading-relaxed mb-4 ${lang === 'ar' ? 'text-right' : ''}`}>
                    {it.summary}
                  </p>
                  <div className={`flex flex-wrap gap-1.5 ${lang === 'ar' ? 'justify-end' : ''}`}>
                    {it.tags.map((t) => (
      ...
      <div className="container mx-auto px-4 py-10 relative z-10">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <div className="flex items-center gap-4">
            {/* Language toggle */}
            <div className="flex items-center gap-1 bg-zinc-900/80 border border-zinc-800 rounded px-1 py-1">
              <button
                onClick={() => setLangPersist('en')}
                className={`px-3 py-1 rounded text-[11px] font-mono transition-all duration-200 ${
                  lang === 'en'
                        ...
                        <div className="p-5 space-y-4">
                          ...
                          <div>
                            <div className="font-mono text-[10px] text-emerald-500 uppercase tracking-widest mb-2">
                              {lang === 'ar' ? 'الدروس' : 'Lessons Learned'}
                            </div>
