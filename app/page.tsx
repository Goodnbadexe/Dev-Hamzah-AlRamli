...
import { ArrowRight, Shield, Terminal, Layers, Radio, Mail, User, ChevronRight, Maximize2, X, Briefcase, Newspaper } from "lucide-react"
...
const ACCENT: Record<string, { border: string; dot: string; icon: string; hover: string }> = {
  ...
  red:     { border: "hover:border-red-700",     dot: "bg-red-500 shadow-[0_0_6px_theme(colors.red.500)]",          icon: "text-red-400",     hover: "group-hover:text-red-300"     },
  cyan:    { border: "hover:border-cyan-800",    dot: "bg-cyan-500 shadow-[0_0_6px_theme(colors.cyan.500)]",        icon: "text-cyan-400",    hover: "group-hover:text-cyan-300"    },
}
